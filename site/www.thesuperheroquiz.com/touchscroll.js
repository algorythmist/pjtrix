...
touchScroll('quiz_div');
// scrollHeight is the height of an element including the non viewable part
//document.getElementById('touchscroll').innerHTML = document.getElementById('quiz_div').scrollHeight;
